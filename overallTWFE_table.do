...
eststo clear
* Discrete case
eststo: reg urbrate c.fpresence##1.post i.id yr1750-yr1900 /* This is equivalent with the ITT, except that we don't have a time trend */

* Binary case
eststo: reg urbrate 1.napoleon##1.post i.id yr1750-yr1900
